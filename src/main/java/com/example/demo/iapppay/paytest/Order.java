...
public class Order {
	 ...
	 * +7dKdHM4ZA=&signtype=RSA 请求地址：以文档给出的为准 再此请格外注意 每个参数值的 数据类型 可选参数 ：waresname
	 * price cpprivateinfo notifyurl
	 */
	/**
	 * 组装请求参数
	 * 
...
//		BareBonesBrowserLaunch.openURL(url);
	...
	public static void main(String[] argv) {
		...
		// CheckSign( String appid, int waresid, String waresname, String cporderid,
